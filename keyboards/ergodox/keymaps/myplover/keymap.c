...
#define SWCH 4 // switch board, might not work the way I hope
#define VIMK 5 // vim normal mode partial emulation
#define BLNK 6 //
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV),KC_QUOT,      LALT(KC_LSFT),  KC_LEFT, TG(SWCH), //KC_RGHT,
                                              ALT_T(KC_APP),  KC_LGUI,
                                                              KC_HOME,
                                               KC_SPC,KC_BSPC,KC_END,
        // right hand
             TG(PLVR),     KC_6,   KC_7,   KC_8,          KC_9,    KC_0,             KC_MINS,
